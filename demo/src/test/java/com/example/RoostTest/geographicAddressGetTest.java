...
public class geographicAddressGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/example/RoostTest/geographicAddressGetTest.csv", envVarsList);
    }
    ...
    public void geographicAddressGet_Test() throws JSONException {
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("addresses") != null) {  
                MatcherAssert.assertThat(response.get("addresses"), instanceOf(undefined.class));  
          }
				}
