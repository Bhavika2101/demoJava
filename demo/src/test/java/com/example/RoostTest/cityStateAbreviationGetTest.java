...
public class cityStateAbreviationGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/example/RoostTest/city_stateAbreviationGetTest.csv", envVarsList);
    }
    ...
    public void cityStateAbreviationGet_Test() throws JSONException {
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("cities") != null) {  
                MatcherAssert.assertThat(response.get("cities"), instanceOf(undefined.class));  
          }
				}
