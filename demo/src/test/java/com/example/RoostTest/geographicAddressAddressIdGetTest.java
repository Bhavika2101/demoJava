...
public class geographicAddressAddressIdGetTest {
    ...
    public void setUp() {
      ...
      envList = dataloader.load("src/test/java/com/example/RoostTest/geographicAddress_addressIdGetTest.csv", envVarsList);
    }
    ...
    public void geographicAddressAddressIdGet_Test() throws JSONException {
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (response.get("addresses") != null) {      
              if (response.get("addresses.address") != null) {  
                MatcherAssert.assertThat(response.get("addresses.address"), instanceOf(undefined.class));  
          }
